...
set confhome=https://raw.githubusercontent.com/momo-z/reinstall/main
set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/momo-z/reinstall/main
rem set confhome_cn=https://jihulab.com/momo-z/reinstall/-/raw/main
